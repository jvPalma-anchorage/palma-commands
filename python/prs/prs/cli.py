...
def run_cli():
    ...
    parser.add_argument("--draft", "-d", action="store_true", default=False, help="Include draft PRs")
    parser.add_argument("--pr_url", type=str, choices=["none", "short", "long"],
                        default=None, help="Set display verbosity for PR URL")
    parser.add_argument("--branch", type=str, choices=["none", "short", "long"],
                        default=None, help="Set display verbosity for branch")
    parser.add_argument("--checks", type=str, choices=["none", "short", "long"],
                        default=None, help="Set display verbosity for checks")
    parser.add_argument("--reviews", type=str, choices=["none", "short", "long"],
                        default=None, help="Set display verbosity for reviews")
    parser.add_argument("--labels", type=str, choices=["none", "short", "long"],
                        default=None, help="Set display verbosity for labels")
